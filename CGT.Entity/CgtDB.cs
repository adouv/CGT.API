...
namespace CGT.Entity.CgtModel1111
{
    ...
    public partial class CgtDB : Database
    {
        ...
        {
            SqlConnection conn = new SqlConnection(JsonConfig.JsonRead("CGTSettings", "cgtConnection"));
            conn.Open();
            return conn;
        }
    ...
    public partial class Guaranteetime : CgtDB.Record<Guaranteetime>
    {
    ...
    public partial class PartnerPermission : CgtDB.Record<PartnerPermission>
    {
