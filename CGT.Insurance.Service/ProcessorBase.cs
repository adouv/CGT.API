...
//        public static readonly string PayCenterApiUrl = "http://localhost:2049/api";
//           // JsonConfig.JsonRead("PayCenterApiUrl", "PayCenter");
//        public static readonly string PayCenterBossApiUrl = "http://localhost:2049/api";
//           /// JsonConfig.JsonRead("PayCenterBossApiUrl", "PayCenter");
...
//                    string.Format("Insurance.Service----target:{1}{0}reqTime:{2:yyyy-MM-dd HH:mm:ss.fff}{0}request:{3}{0}resTime:{4:yyyy-MM-dd HH:mm:ss.fff}{0}response:{5}{0}",
