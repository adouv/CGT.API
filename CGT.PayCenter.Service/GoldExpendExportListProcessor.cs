...
namespace CGT.PayCenter.Service
{
    ...
    /// 修改描述 :
    /// </remarks>
    public class GoldExpendExportListProcessor : ProcessorBase<List<GoldExpendInquiryList>>
    {
        ...
        private readonly int _expenditureType;
        private readonly double _maxAmt;
        private readonly double _minAmt;
        ...
        public GoldExpendExportListProcessor(
             DateTime startDate,DateTime endDate, string companyCode, string companyOrderId,string reapalNo,string payName, int expenditureType,double maxAmt,double minAmt,  string accountName, string companyName,string stepNo)
        {
            ...
            _reapalNo = reapalNo;
            _payName = payName;
            _expenditureType = expenditureType;
            _maxAmt = maxAmt;
            _minAmt = minAmt;
        ...
        {
            get { return "ExpendGolden/expendExport"; }
        }
        ...
        protected override Dictionary<string, object> PrepareRequestCore()
        {
            ...
            request.Add("expenditureType", _expenditureType);
