...
namespace CGT.PayCenter.Service
{
    ...
    /// 修改描述 :
    /// </remarks>
    public class OrderExportProcessor : ProcessorBase<List<orderExportList>>
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public OrderExportProcessor(DateTime startDate, DateTime endDate, string departureEndDate, string departureStartDate,
        ...
        {
            get { return "OrderAction/orderExport"; }
        }
