...
namespace CGT.PayCenter.Service
{
    ...
    /// 修改描述 :
    /// </remarks>
    public class GoldIncomeExportListProcessor : ProcessorBase<List<GoldIncomeExportList>>
    {
        ...
        public GoldIncomeExportListProcessor(
        ...
        {
            get { return "IncomeGolden/incomeExport"; }
        }
