...
namespace CGT.Api.Service.Boss.TravelOrder {
    ...
    /// 获取差旅订单详情
    /// </summary>
    public class GetTravelOrderListService : ApiBase<RequestTravelOrderList> {
        #region 注入服务
